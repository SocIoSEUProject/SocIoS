							...
							<div class="EDGcornertopleft">
								<div class="EDGcornertopright">
									<div class="EDGcontent" style="text-align: center;">
										...
										<br />
										<asp:gridview id="gvVGalPagination" runat="server" allowpaging="True" autogeneratecolumns="False" datakeynames="PictureID" datasourceid="odsGetVideos" horizontalalign="Center" onpageindexchanged="gvVGalPagination_PageIndexChanged" onselectedindexchanged="gvVGalPagination_SelectedIndexChanged"
...
<asp:objectdatasource id="odsGetVideos" typename="DataAcess" runat="server" selectmethod="GetRandomVideosFromGallery">
	<selectparameters>
