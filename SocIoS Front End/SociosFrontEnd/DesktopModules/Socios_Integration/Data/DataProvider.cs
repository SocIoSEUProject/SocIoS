...
namespace DotNetNuke.Modules.Socios_Integration.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Socios_Integration.Data.SqlDataprovider,Socios_Integration";
