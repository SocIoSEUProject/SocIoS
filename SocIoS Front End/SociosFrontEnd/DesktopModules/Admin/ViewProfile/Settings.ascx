...
<div class="dnnForm dnnViewProfileSettings dnnClear">
	<div class="dnnFormItem">
		<dnn:label id="lblIncludeButton" runat="server" ControlName="IncludeParent" ResourceKey="IncludeButton" Suffix=":" />
		 <asp:Checkbox ID="IncludeButton" runat="server" Checked="True" />
	</div>
    <div class="dnnFormItem">
        <dnn:Label ID="plTemplate" runat="server" ControlName="txtTemplate" Suffix=":" />
