							...
							<div class="EDGcornertopleft">
								<div class="EDGcornertopright">
									<div class="EDGcontent" style="text-align: center;">
										...
										<asp:DataList ID="dlAudioGallery" runat="server" Font-Bold="False" Font-Italic="False"
											...
											<ItemTemplate>
												...
												<div style="clear: both; display: block; text-align: center;">
													<asp:HyperLink ID="hlDownloadImage" runat="server" NavigateUrl='<%#GetImageDownURL(Eval("FileName"))%>'
														Visible='<%#GetDownloadVisible(Eval("HiResVersion"))%>' CssClass="downloadlink"><%=ViewState["strDownloadAudio"]%></asp:HyperLink></div>
										...
										<br />
										<asp:DataList ID="repAudioList" runat="server" ShowFooter="False" 
											ShowHeader="False" DataKeyField="PictureID" HorizontalAlign="Center" 
											onitemcommand="repAudioList_ItemCommand">
											<ItemTemplate>
												<div class="EDGmain">
													<div class="EDGimage">
