...
namespace DotNetNuke.Modules.Socios_OAuthTokenManager.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Socios_OAuthTokenManager.Data.SqlDataprovider,Socios_OAuthTokenManager";
