...
namespace DotNetNuke.Modules.Socios_TranslationWidget.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Socios_TranslationWidget.Data.SqlDataprovider,Socios_TranslationWidget";
