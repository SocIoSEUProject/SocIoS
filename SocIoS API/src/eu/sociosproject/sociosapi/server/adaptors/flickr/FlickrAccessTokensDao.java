...
public class FlickrAccessTokensDao implements SnsAccessTokensDao<FlickrAcessTokens>{
	

	@Override
	public FlickrAcessTokens get(String sociosUserApiKey) {       
		return new FlickrAcessTokens("72157627308196706-84fc054fc590caa5");
	}
}
