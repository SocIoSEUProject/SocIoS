...
namespace DotNetNuke.Modules.Socios_MediaSearch.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Socios_MediaSearch.Data.SqlDataprovider,Socios_MediaSearch";
