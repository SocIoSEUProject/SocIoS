								...
								<div class="EDGcornertopright">
									<div class="EDGcontent" style="text-align: left;">
											...
											<ItemTemplate>
												...
												<div style="clear: both; display: block; text-align: center;">
													<asp:HyperLink ID="hlDownloadImage" runat="server" NavigateUrl='<%#GetImageDownURL(Eval("FileName"))%>'
														Visible='<%#GetDownloadVisible(Eval("HiResVersion"))%>' CssClass="downloadlink"><%=ViewState["strDownloadAudio"]%></asp:HyperLink>
												</div>
										...
										<asp:DataList ID="repAudioList" runat="server" ShowFooter="False" ShowHeader="False"
											 DataKeyField="PictureID" OnItemCommand="repAudioList_ItemCommand" HorizontalAlign="Center" 
