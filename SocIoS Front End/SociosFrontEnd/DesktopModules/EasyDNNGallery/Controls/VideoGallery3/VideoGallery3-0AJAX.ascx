...
function InsertSWF(fileName,vidWidth, vidHeight)
{
     <%=ViewState["jQuery"]%>(document).ready(function() {
                                                            ...
                                                            var attributes = {};
                                                            swfobject.embedSWF(fileName, '<%=ViewState["ModulNr"]%>swf', vidWidth, vidHeight, "9.0.0",'<%=ModulePath.Replace("Controls/VideoGallery3/","")%>js/expressInstall.swf', flashvars, params, attributes);
                                                        }); 
}
...
if('<%=ViewState["UseFlowPlayer"]%>'=='True')
 {
                flowplayer('player'+picID,{scaling: '<%=ViewState["FlowScaling"]%>', allowfullscreen:<%= ViewState["AllowFullFlow"]%>,src:'<%=ModulePath.Replace("Controls/VideoGallery3/","")%>flowplayer.swf',wmode: "transparent"},{
			                                                     clip: {
   ...
   function InsertFP(vfilename,sphoto,vidwidth1,vidheight1,vidwidth2,vidheight2,idesc)
    {                                              
                                               ...
                                               // params.wmode='window';
                                                ...
                                                attributes.id = 'pp'
                                                /* ]]> */                
                                                swfobject.embedSWF('<%=ModulePath.Replace("Controls/VideoGallery3/","")%>preview.swf', '<%=ViewState["ModulNr"]%>', vidwidth2, vidheight2, '9.0.0', '<%=ModulePath.Replace("Controls/VideoGallery3/","")%>js/expressInstall.swf', flashvars, params, attributes);
                                              });   
  }                                                                        
</script>
...
//        itmpos = document.getElementById(hiddenControl).value;
        ...
        if (<%=ViewState["jQuery"]%>.browser.msie && <%=ViewState["jQuery"]%>.browser.version < "8.0") {
            ...
            <%=ViewState["jQuery"]%>('.image_carousel').css('height', 'auto');}
                ...
                <%=ViewState["jQuery"]%>(window).load(function() {
	                ...
	                scroll	: {
		                         ...
		                         onAfter : function(oldItems, newItems) {
                                  itmpos = edgcar.current_position();
	                              }
	                        },
                ...
                <%=ViewState["jQuery"]%>('.image_carousel').css('overflow', 'visible');
                <%=ViewState["jQuery"]%>('.image_carousel').css('height', 'auto');                
                <%=ViewState["jQuery"]%>('#IC<%=ViewState["ModulNr"]%>').trigger("slideTo", itmpos);
            });
                                        ...
                                        <asp:DataList ID="dlVideos"  runat="server" Font-Bold="False" Font-Italic="False"
                                                    ...
                                                    <div id="embedvideo" style="z-index: 0">
                                                        ...
                                                        <div class="VideoDescription">
                                                            <asp:Label ID="lblVGEVMediaDescription" CssClass="EDGTitleText" runat="server" 
                                                                Text='<%# ShowDescription(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>' ></asp:Label></div>
                                                    </div>
                                                </asp:PlaceHolder>
                                                ...
                                                <asp:PlaceHolder ID="phEVVideo" runat="server" 
                                                    ...
                                                    <div class="VideoTitle">
                                                        <asp:Label ID="lblVGEVMediaTitle2" runat="server" CssClass="EDGTitleText" 
                                                            Text='<%#ShowTitle(DataBinder.Eval(Container.DataItem, "Title"),DataBinder.Eval(Container.DataItem, "PictureID"))%>' ></asp:Label></div>
                                            ...
                                            <%=ViewState["jQuery"]%>(document).ready(function() {                    
                                               ...
                                               // params.wmode='window';
                                                ...
                                                attributes.id = 'pp'
                                                /* ]]> */                
                                                swfobject.embedSWF('<%=ModulePath.Replace("Controls/VideoGallery3/","")%>preview.swf', '<%=ViewState["ModulNr"]%>', '<%#GetVideoWidth(DataBinder.Eval(Container.DataItem, "MediaType"),DataBinder.Eval(Container.DataItem, "FileName"))%>', '<%# GetVideoHeight(DataBinder.Eval(Container.DataItem, "MediaType"),DataBinder.Eval(Container.DataItem, "FileName"))%>', '9.0.0', '<%=ModulePath.Replace("Controls/VideoGallery3/","")%>js/expressInstall.swf', flashvars, params, attributes);
                                              });                                                                           
                                                    </script>
                                                ...
                                                <asp:PlaceHolder ID="phEVVideoFlow" runat="server" Visible='<%# ToDisplayVideo2Flow("Video",DataBinder.Eval(Container.DataItem, "MediaType"),DataBinder.Eval(Container.DataItem, "Info"),DataBinder.Eval(Container.DataItem, "FileName"),"Flow") %>'>                                                    
                                                            ...
                                                            <div class="VideoTitle">
                                                            <asp:Label ID="Label4" runat="server" CssClass="EDGTitleText" 
                                                            Text='<%#ShowTitle(DataBinder.Eval(Container.DataItem, "Title"),DataBinder.Eval(Container.DataItem, "PictureID"))%>' ></asp:Label></div>
                                                            <div class="VideoBodyPlayer">
                                                            <a  
			                                                     href='<%#GetFlowFileName(DataBinder.Eval(Container.DataItem, "FileName"))%>'
			                                                     style='display:block; width: <%#GetFlowVideoWidth(DataBinder.Eval(Container.DataItem, "MediaType"),DataBinder.Eval(Container.DataItem, "FileName"))%>px;height:<%# GetFlowVideoHeight(DataBinder.Eval(Container.DataItem, "MediaType"),DataBinder.Eval(Container.DataItem, "FileName"))%>px'  
			                                                     id='player<%#Eval("PictureID")%>'> 
			                                                    <%-- <img src='<%#DataBinder.Eval(Container.DataItem, "ThumbUrl")%>'/>--%>
		                                                    </a> 
                                                    ...
                                                    <div class="VideoDescription">
                                                        <asp:Label ID="lblVGEVMediaDescription2Flow" runat="server" 
                                                            Text='<%# ShowDescription(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>' >
                                                       </asp:Label></div>
                                                    </asp:PlaceHolder>
