<%@ control language="C#" autoeventwireup="true" inherits="EasyDNN.Modules.EasyDNNGallery.DesktopModules_EasyDNNGallery_Controls_LightboxCaptionSlideControl, App_Web_lightboxcaptionslider1.ascx.2bf93430" debug="True" %>
...
<div id="LightBoxGallery" runat="server">
	<asp:Panel ID="upTableGallery" runat="server">    
																...
																<a href="" runat="server">
																	...
																	<span class="round4"></span><span class='<%#NGTitleClass(DataBinder.Eval(Container.DataItem, "GalleryName"),DataBinder.Eval(Container.DataItem, "GalleryDescription"))%>'>
																		...
																		<asp:Label ID="lbGalleryLink" runat="server" CssClass="Description" Text='<%#GetMediaInfo(Eval("GalleryID"))%>'
																			Visible='<%#Convert.ToBoolean(ViewState["GalleryInfo"])%>'></asp:Label>
																			...
																			<div class="<%=ViewState["ModulNr"]%> EDGboxslide EDGdesccaption">
																				...
																				<div class="<%=ViewState["ModulNr"]%> EDGslide EDGboxcaption">
																					...
																					<div class="EDGslidetext">
																						<h3>
																							<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   href='<%#LinkOrLightbox(Eval("FileName"),Eval("ImageUrl"),Eval("PictureID")) %>'
																						...
																						<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   class="btnslide" lbnestedurl='<%#GetLighboxNestedURL()%>'
																							downhref='<%#GetLighboxImageDownURL(Eval("HiResVersion"),Eval("FileName"))%>'
																							href='<%#LinkOrLightbox(Eval("FileName"),Eval("ImageUrl"),Eval("PictureID")) %>'
																							target="<%#TargetWin()%>" title='<%#GetDescription3(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'
																							rel="<%#RelLink2()%>">
																		...
																		<div class="shadowborder">
																			<div class="<%=ViewState["ModulNr"]%> EDGboxslide EDGdesccaption">
																				...
																				<div class="<%=ViewState["ModulNr"]%> EDGslide EDGboxcaption">
																					...
																					<div class="EDGslidetext">
																						<h3>
																							<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   href='<%#FixVimeo(Eval("ShortEmbedUrl"),GetLightBoxSize(DataBinder.Eval(Container.DataItem, "Info"),DataBinder.Eval(Container.DataItem, "Filename")))%>'
																						...
																						<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   class="btnslide" href='<%#FixVimeo(Eval("ShortEmbedUrl"),GetLightBoxSize(DataBinder.Eval(Container.DataItem, "Info"),DataBinder.Eval(Container.DataItem, "Filename")))%>'
																					...
																					<div class="EDGslidetext">
																						...
																						<p>
																							<asp:Label ID="Label3" runat="server" Text='<%#ShowDescription(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'
																								Visible='<%#DescriptionToDisplay(Eval("Description"),Eval("PictureID"))%>'></asp:Label></p>
																						<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   class="btnslide" href='<%#Eval("FileName")%>'
																							rel="" title='<%#GetDescription3(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'>
																					...
																					<div class="EDGslidetext">
																						...
																						<p>
																							<asp:Label ID="lblTGDescription3" runat="server" Text='<%#ShowDescription(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'
																								Visible='<%#DescriptionToDisplay(Eval("Description"),Eval("PictureID"))%>'></asp:Label></p>
																						<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   class="btnslide" href='<%=ViewState["hostpath"]%><%=ModulePath.Replace("Controls/LightboxCaptionSlider/","")%>video.html?videourl=<%#RepVidNames(Eval("MediaType"),Eval("FileName"))%>&playerskin=<%=ViewState["VGSkin"]%>&playonload=<%=ViewState["PlayOnLoad"]%>&info=<%=ViewState["Info"]%>&description=<%#GetDescription2(DataBinder.Eval(Container.DataItem, "Description"))%>&fullscreen=<%=ViewState["AllowFullscren"]%>&iframe=true<%# RepNames(Eval("MediaType"),Eval("ShortEmbedUrl"))%>'
																							rel="<%#RelLink2()%>" title='<%#GetDescription3(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'>
																							<%=ViewState["strOpenMedia"]%></a></div>
																				</div>
																			</div>
																			...
																			<div class="<%=ViewState["ModulNr"]%> EDGboxslide EDGdesccaption">
																				<div class="EDGslidetext">
																					...
																					<div class="<%=ViewState["ModulNr"]%> EDGslide EDGboxcaption">
																						...
																						<div class="EDGslidetext">
																							<h3>
																								<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   href='<%#Eval("Filename") %>' rel="<%#RelLink()%>"
																					...
																					<div class="EDGslidetext">
																						...
																						<p>
																							<asp:Label ID="Label9" runat="server" Text='<%# ShowDescription(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'
																								Visible='<%#DescriptionToDisplay(Eval("Description"),Eval("PictureID"))%>'></asp:Label></p>
																						<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   class="btnslide" href='<%=ModulePath.Replace("Controls/LightboxCaptionSlider/","")%>mp3player.swf?flashvars=autoLoad=true&autoPlay=<%=ViewState["AudioPlayOnLoad"]%>&volume=1&song1url=<%=ViewState["hostpath"]%><%#Eval("Filename")%>&width=560&height=33&salign=middle&swliveconnect=true&allowscriptaccess=always&wmode=transparent'
																							rel="<%#RelLink2()%>" title='<%#GetDescription3(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'>
																							<%=ViewState["strOpenMedia"]%></a></div>
																				</div>
																			</div>
																		...
																		<div class="shadowborder">
																			<div class="<%=ViewState["ModulNr"]%> EDGboxslide EDGdesccaption">
																				...
																				<div class="<%=ViewState["ModulNr"]%> EDGslide EDGboxcaption">
																					...
																					<div class="EDGslidetext">
																						<h3>
																							<a edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>'   href='<%#Eval("Filename")%>' title='<%#GetDescription3(DataBinder.Eval(Container.DataItem, "Description"),DataBinder.Eval(Container.DataItem, "PictureID"))%>'>
