...
namespace DotNetNuke.Modules.Socios_RoleChecker.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Socios_RoleChecker.Data.SqlDataprovider,Socios_RoleChecker";
