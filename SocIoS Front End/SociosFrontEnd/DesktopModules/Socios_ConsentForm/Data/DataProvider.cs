...
namespace DotNetNuke.Modules.Socios_ConsentForm.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.Socios_ConsentForm.Data.SqlDataprovider,Socios_ConsentForm";
