...
<style type="text/css">
	...
	#LightBoxGallery .EDGresponsive table.Lightbox2table
	{
		width:100%;
		
	}
	
    #LightBoxGallery .EDGlightboxNested.EDGresponsive .Lightbox2table td
	{
		width: 47%;
		
	}
	
	#LightBoxGallery .EDGlightbox.EDGresponsive .Lightbox2table td
	{
		width: 47%;
    ...
    #LightBoxGallery .EDGresponsive div.titleimage,  #LightBoxGallery .EDGresponsive div.title, #LightBoxGallery .EDGresponsive .title span, #LightBoxGallery .EDGresponsive div.descimage
    {
        width:100%!important;
        max-width: <%=ViewState["TGImageWidth"]%>px;
        }
									...
									<div class="EDGcornertopright">
										<div class="EDGcontent">
														...
														<table cellpadding="0" cellspacing="0" class="Lightbox2table">
															<tr>
																...
																<td valign="top" style="padding-top: 10px;">
																	<div class="titleimage" style='width: <%=ViewState["NGThumbWidth"]%>px;'>
																	...
																	<div class="descimage" style='width: <%=ViewState["NGThumbWidth"]%>px;'>
											...
											<asp:Panel ID="pnlTGDisplay" runat="server" HorizontalAlign="Center">
												...
												<asp:ObjectDataSource ID="odsTGMedia" runat="server" TypeName="DataAcess" SelectMethod="GetRandomImagesFromGallery"
														...
														<asp:PlaceHolder ID="plImage" runat="server" Visible='<%# ToDisplay("Image",DataBinder.Eval(Container.DataItem, "MediaType"))%>'>
															<table cellpadding="2" cellspacing="2" class="Lightbox2table">
																<tr>
																		...
																		<div class="EDGmain">
																			<div class="EDGimage">
																				<a href='<%#Eval("LinkOrLightbox")%>' downhref='<%#Eval("GetLighboxImageDownURL")%>'
																					edgpid='<%#Eval("PictureID")%>' edgmid='<%=ViewState["ModuleIDNR"]%>' target="<%#Eval("TargetWin")%>"
																	...
																	<td valign="top" style="padding-top: 10px;">
																		<div class="titleimage" style='width: <%=ViewState["TGImageWidth"]%>px;'>
																		...
																		<div style='width: <%=ViewState["TGImageWidth"]%>px;' class="descimage">
																		...
																		<div class="ViewDetailsLink">
																			<a href='<%#Eval("LinkOrLightbox")%>' downhref='<%#Eval("GetLighboxImageDownURL")%>'
																				...
																				edgmid='<%=ViewState["ModuleIDNR"]%>' target="<%#Eval("TargetWin")%>" e='<%#Eval("GetDescription3")%>'
																				rel="<%#RelLink2()%>">
																				<%=ViewState["OpenLinkText"]%></a></div>
																	</td>
																</tr>
															</table>
																		...
																		<div class="EDGmain">
																			<div class="EDGvideo">
																				<video controls="true" src='<%#Eval("Filename") %>' poster='<%#Eval("GetThumbPath") %>'
																					width='<%=ViewState["TGImageWidth"]%>' height='<%=ViewState["TGImageHeight"]%>'>
															...
															<table cellpadding="2" cellspacing="2" class="Lightbox2table">
																<tr>
																	...
																	<td valign="top" style="padding-top: 10px;" class="descimage">
																		...
																		<div style='width: <%=ViewState["TGImageWidth"]%>px;'>
																			<asp:Label ID="Label9" CssClass="DescriptionImage" runat="server" Text='<%#Eval("ShowDescription")%>'
																				Visible='<%#Eval("DescriptionToDisplay")%>'></asp:Label></div>
																		<div class="ViewDetailsLink">
																			<a href='<%#Eval("Filename")%>' lbnestedurl='<%#Eval("GetLighboxNestedURL")%>' edgpid='<%#Eval("PictureID")%>'
																				edgmid='<%=ViewState["ModuleIDNR"]%>' e='<%#Eval("GetDescription3")%>'>
																				<%=ViewState["OpenLinkText"]%></a></div>
																	</td>
																</tr>
															</table>
