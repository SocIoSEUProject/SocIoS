                                ...
                                <div class="EDGcornertopright">
                                    <div class="EDGcontent" style="text-align: center;">
                                        ...
                                        <asp:DataList ID="dlVideos" runat="server" Font-Bold="False" Font-Italic="False"
                                            ...
                                            <asp:PlaceHolder ID="phEVVideoFlow" runat="server" 
                                                    Visible='<%# ToDisplayVideo2Flow("Video",DataBinder.Eval(Container.DataItem, "MediaType"),DataBinder.Eval(Container.DataItem, "Info"),DataBinder.Eval(Container.DataItem, "FileName"),"Flow") %>'>
                                                    ...
                                                    <div class="VideoBodyPlayer">
                                                       <a  
                                                        ...
                                                        <script type="text/javascript">
                			                                                // flowplayer('player<%#Eval("PictureID")%>', '<%=ModulePath.Replace("Controls/","")%>flowplayer.swf', {
                                                                            //	clip: {
                                                                            //		
