...
**********/	
        ...
        _appendOption: function(option, container, index, indent, forceDisabled) {
            ...
            var item = self._createDropItem(index, tabIndex, value, text, optCss, option[0].selected, disabled, indent);
        ...
        _syncSelected: function(senderCheckbox) {
            ...
            if (options.firstItemChecksAll) {
            	if ((senderCheckbox == null) && selectOptions[0].selected ) {
            ...
            allCheckboxes.each(function(index) {
                selectOptions[index].selected = this.checked;
            });
        ...
        _formatText: function(selectOptions, firstItemChecksAll, firstOption) {
            ...
            } else if (firstItemChecksAll && (firstOption != null) && firstOption[0].selected) {
        ...
        refresh: function() {
			...
			sourceSelect.children().each(function(index) {
                ...
                if (opt.is("option")) {
                    ...
                    self._refreshOption(anItem, disabled, opt[0].selected);
                    optionCount += 1;
                } else if (opt.is("optgroup")) {
                    var text = opt.attr("label");
                    if (text != "") {
					...
					opt.children("option").each(function() {
		                ...
		                self._refreshOption(subItem, subdisabled, subopt[0].selected );
		                optionCount += 1;
		            });
                }
			});
